...
Recurring Artifact Evaluation committee members at security conferences ({{ site.data.summary.security_conferences | join: ", " }}), ranked by AE service score (3×memberships + 2×chairs). Only members who served at least twice are listed. The **Chaired** column (★) indicates how many times the member served as AE chair or co-chair.
