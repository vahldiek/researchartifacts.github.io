...
Researchers ranked by weighted contributions (artifact authorship + AE committee service). **Scoring:** Each badge (Available, Functional, Reproduced) = 1 pt, each citation = 1 pt; AE membership = 3 pts, AE chair = 5 pts. Use the filters below. Data from [DBLP](https://dblp.org), evaluations, and committee listings.
